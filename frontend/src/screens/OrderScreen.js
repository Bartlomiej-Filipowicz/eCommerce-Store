...
function OrderScreen() {
  ...
  const addPayPalScript = () => {
    ...
    script.src =
      "https://www.paypal.com/sdk/js?client-id=Afgpg65Eiuo4UxglW1pMP3Ch8vmI62-7V5d7aHvLMXwU5x2Yyaxa1jbDoGcnSytVGpcBNanfgLwNR7hK&currency=USD";
    script.async = true;
    script.onload = () => {
      setSdkReady(true);
    };
          ...
          <Card className="mt-0 p-3 border border-2 rounded-3 border border-light">
            <ListGroup variant="flush">
              ...
              <ListGroup.Item>
                <Row>
                  <Col>
                    <strong className="text-light">Items </strong>
                  </Col>

...
function PlaceOrderScreen() {
  ...
  const itemsPrice = cart.cartItems
    ...
    .toFixed(2); // it doesn't update the store, it's only for this page
  ...
  useEffect(() => {
    ...
    if (success) {
      navigate(`/order/${order.id}`); // replaces history.push()
          ...
          <Card className="mt-0 p-3 border border-2 rounded-3 border border-light">
            <ListGroup variant="flush">
              ...
              <ListGroup.Item>
                <Row>
                  <Col>
                    <strong class="text-light">Shipping </strong>
                  </Col>
              ...
              <ListGroup.Item>
                <Row>
                  <Col>
                    <strong class="text-light">Tax </strong>
                  </Col>
                  <Col>${taxPrice}</Col>
                </Row>
              </ListGroup.Item>

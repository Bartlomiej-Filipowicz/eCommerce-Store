...
class Product(models.Model): # <- thanks to this inheritance Djnago knows that Product is a model
    ...
    createdAt = models.DateTimeField(auto_now_add=True) # takes the date and time the moment an object is created
...
class ShippingAddress(models.Model):
    order = models.OneToOneField(Order, on_delete=models.CASCADE, null=True, blank=True) # an order can have only one shipping address
